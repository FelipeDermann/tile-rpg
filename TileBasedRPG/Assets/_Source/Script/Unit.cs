...
public class Unit : MonoBehaviour
{
    ...
    [HideInInspector] public UnitSkills unitSkills;
    [HideInInspector] public UnitUI unitUI;
    [HideInInspector] public UnitStats unitStats;
    [HideInInspector] public UnitAnimations unitAnims;

    [Header("Test")]
    public float healthTest = -20;

    public void InitiateUnit(BattleTile tileToSpawnAt)
    {
        AssignEvents();
        AssignFirstTile(tileToSpawnAt);
    ...
    void AssignEvents()
    {
        ...
        unitAnims = GetComponent<UnitAnimations>();
