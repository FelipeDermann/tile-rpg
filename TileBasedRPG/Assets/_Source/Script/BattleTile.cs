...
public class BattleTile : MonoBehaviour
{
    ...
    {
        anim.Play("Danger", 0, GlobalHexAnimManager.NormalizedAnimTime);
    ...
    public void PlayHealAnim()
    {
        ...
        anim.Play("Heal", 0, GlobalHexAnimManager.NormalizedAnimTime);
    }
    ...
    public void PlayBuffAnim()
    {
        ...
        anim.Play("Buff", 0, GlobalHexAnimManager.NormalizedAnimTime);
    }
    ...
    public void PlayDebuffAnim()
    {
        ...
        anim.Play("Debuff", 0, GlobalHexAnimManager.NormalizedAnimTime);
    }
